...
export const heroLeistungen = [
  ...
  {
    titel: "Labordiagnostik & Vitamin-Infusionen",
    claim: "Blut, Stuhl und Speichel zeigen, was Ihr Körper braucht",
  },
];
...
export const leistungsGruppen = [
  ...
  },
  {
    id: "stoffwechsel",
    nummer: "04",
    titel: "Labor, Stoffwechsel & Ernährung",
    claim: "Regeneration beginnt im Inneren",
    intro:
      "Wie gut Gewebe heilt und wie viel Energie Ihnen zur Verfügung steht, entscheidet sich zu einem großen Teil im Stoffwechsel. Deshalb endet die Behandlung in der Praxis INNNatur bewusst weder an der Haut noch an der Muskulatur. Laboranalysen machen sichtbar, was im Inneren geschieht, und Infusionen wirken genau dort.",
    bild: "/images/praxis-2.webp",
    bildAlt: "Heller Behandlungsraum der Praxis INNNatur mit grüner Therapieliege",
    leistungen: [
      {
        name: "Labordiagnostik",
        text: "Analysen von Blut, Stuhl und Speichel ermöglichen die gezielte Suche nach Schwachstellen und zeigen den aktuellen Status von Mineralien, Vitaminen und Darmflora. Jede Empfehlung beruht so auf messbaren Werten.",
      },
      {
        name: "Vitamin-Infusionen",
        text: "Maßgeschneiderte Infusionen mit Vitaminen, Mineralstoffen und Aminosäuren füllen Ihre Nährstoffspeicher direkt über die Blutbahn auf und stärken den Körper von innen heraus.",
      },
      {
...
export const featuredLeistungen = [
  ...
  {
    name: "Labor & Infusionen",
    text: "Analysen von Blut, Stuhl und Speichel decken Schwachstellen auf, maßgeschneiderte Vitamin-Infusionen füllen die Speicher wieder auf.",
...
export const stats = [
  ...
  { zahl: 16, suffix: "", label: "Behandlungsmethoden unter einem Dach" },
